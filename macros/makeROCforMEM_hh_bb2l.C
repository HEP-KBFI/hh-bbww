...
void makeROCforMEM_hh_bb2l()
{
  ...
  plotNames.push_back("MEM_genMatchOpt1");
  plotNames.push_back("MEM_genMatchOpt2");
  plotNames.push_back("MEM_genMatchOpt3");
  plotNames.push_back("BDT");
  ...
  legendEntries["MEM_genMatchOpt2"] = "MEM opt2";
  legendEntries["MEM_genMatchOpt3"] = "MEM opt3";
  legendEntries["BDT"] = "BDT";
  legendEntries["mHHvis"] = "m_{HH}^{vis}";
