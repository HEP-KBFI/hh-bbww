  ...
  , plot_DNN_correlation_(plot_DNN_correlation)
{
  ...
  central_or_shiftOptions_["bjet2_btagCSV"] = { "central" };
  central_or_shiftOptions_["wjet1_btagCSV"] = { "central" };
  central_or_shiftOptions_["wjet2_btagCSV"] = { "central" };
  ...
  central_or_shiftOptions_["mbb_medium"] = { "central" };
  central_or_shiftOptions_["dR_b1lep"] = { "*" };
  central_or_shiftOptions_["dR_b2lep"] = { "central" };
  central_or_shiftOptions_["mjj_highestpt"] = { "central" };
