  ...
  , plot_DNN_correlation_(plot_DNN_correlation)
{
  ...
  central_or_shiftOptions_["met_phi"] = { "*" };
  central_or_shiftOptions_["lepPairCharge_loose"] = { "*" };
  central_or_shiftOptions_["m_wlep"] = { "*" };
  central_or_shiftOptions_["met_LD"] = { "*" };
  central_or_shiftOptions_["lep_pt"] = { "*" };
  central_or_shiftOptions_["mll_loose"] = { "*" };
  central_or_shiftOptions_["m_Hbb"] = { "*" };
  central_or_shiftOptions_["pT_Hbb"] = { "*" };
  central_or_shiftOptions_["dR_Hbb"] = { "*" };
  central_or_shiftOptions_["m_Hbb_regCorr"] = { "*" };
  central_or_shiftOptions_["dPhi_Hww"] = { "*" };
  ...
  central_or_shiftOptions_["dPhi_HHvis"] = { "*" };
  ...
  central_or_shiftOptions_["mindr_lep1_jet"] = { "*" };
  central_or_shiftOptions_["avg_dr_jet_central"] = { "*" };
  central_or_shiftOptions_["lepPairType_loose"] = { "*" };
  central_or_shiftOptions_["selLepton_type"] = { "*" };
  central_or_shiftOptions_["mbb_medium"] = { "*" };
  central_or_shiftOptions_["dR_b1lep"] = { "*" };
  central_or_shiftOptions_["dR_b2lep"] = { "*" };
  central_or_shiftOptions_["mjj_highestpt"] = { "*" };
  central_or_shiftOptions_["numJetsForward"] = { "*" };
  central_or_shiftOptions_["tau21_Hbb"] = { "*" };
  central_or_shiftOptions_["lep_eta"] = { "*" };
  central_or_shiftOptions_["lep_phi"] = { "*" };
  central_or_shiftOptions_["lep_e"] = { "*" };
  central_or_shiftOptions_["Hbb_lead_pt"] = { "*" };
  central_or_shiftOptions_["Hbb_lead_eta"] = { "*" };
  central_or_shiftOptions_["Hbb_lead_phi"] = { "*" };
  central_or_shiftOptions_["Hbb_lead_m"] = { "*" };
  central_or_shiftOptions_["Hbb_sublead_pt"] = { "*" };
  central_or_shiftOptions_["Hbb_sublead_eta"] = { "*" };
  central_or_shiftOptions_["Hbb_sublead_phi"] = { "*" };
  central_or_shiftOptions_["Hbb_sublead_m"] = { "*" };
  central_or_shiftOptions_["Wjj_lead_pt"] = { "*" };
  central_or_shiftOptions_["Wjj_lead_eta"] = { "*" };
  central_or_shiftOptions_["Wjj_lead_phi"] = { "*" };
  central_or_shiftOptions_["Wjj_lead_m"] = { "*" };
  central_or_shiftOptions_["Wjj_sublead_pt"] = { "*" };
  central_or_shiftOptions_["Wjj_sublead_eta"] = { "*" };
  central_or_shiftOptions_["Wjj_sublead_phi"] = { "*" };
  central_or_shiftOptions_["Wjj_sublead_m"] = { "*" };
  central_or_shiftOptions_["jet1_pt"] = { "*" };
  central_or_shiftOptions_["jet1_eta"] = { "*" };
  central_or_shiftOptions_["jet1_phi"] = { "*" };
  central_or_shiftOptions_["jet2_pt"] = { "*" };
  central_or_shiftOptions_["jet2_eta"] = { "*" };
  central_or_shiftOptions_["jet2_phi"] = { "*" };
  ...
  central_or_shiftOptions_["m_Hww"] = { "*" };
  central_or_shiftOptions_["m_HH_bbregCorr"] = { "*" };
  central_or_shiftOptions_["dPhi_met_lep"] = { "*" };
  central_or_shiftOptions_["dR_lep_Wjj"] = { "*" };
  central_or_shiftOptions_["dR_lep_Hbb"] = { "*" };
  central_or_shiftOptions_["pT_wlep"] = { "*" };
  central_or_shiftOptions_["dPhi_met_Hbb"] = { "*" };
  central_or_shiftOptions_["dPhi_met_Wjj"] = { "*" };
