#ifndef hhAnalysis_bbww_MEMOutputWriter_hh_bb1l_h
#define hhAnalysis_bbww_MEMOutputWriter_hh_bb1l_h
...
class MEMOutputWriter_hh_bb1l
{
public:
  MEMOutputWriter_hh_bb1l(const std::string & branchName_num,
			  const std::string & branchName_obj);
  ~MEMOutputWriter_hh_bb1l();

  /**
   * @brief Call tree->Branch for all MEMOutput_hh_bb1l branches
   */
  void setBranches(TTree * tree);

  /**
   * @brief Write collection of MEMOutput_hh_bb1l objects to tree
   */
  void write(const std::vector<MEMOutput_hh_bb1l> & memOutputs);
...
#endif // hhAnalysis_bbww_MEMOutputWriter_hh_bb1l_h
