...
# file generated at 2020-10-13 13:12:12 with the following command:
...
meta_dictionary["/TTTo2L2Nu_hdampDOWN_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         21644000),
  ("nof_db_files",          509),
  ("fsize_db",              1222951671526),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.22TB; nevents: 21.64M; release: 10_2_5; last modified: 2020-10-09 12:53:02"),
])
...
meta_dictionary["/TTTo2L2Nu_hdampUP_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         18948000),
  ("nof_db_files",          392),
  ("fsize_db",              1076411958031),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.08TB; nevents: 18.95M; release: 10_2_5; last modified: 2020-10-09 10:06:43"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5CR1_QCDbased_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         28380000),
  ("nof_db_files",          629),
  ("fsize_db",              1598740404048),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.60TB; nevents: 28.38M; release: 10_2_5; last modified: 2020-10-09 10:13:26"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5CR2_GluonMove_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         29790000),
  ("nof_db_files",          632),
  ("fsize_db",              1665211428044),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.67TB; nevents: 29.79M; release: 10_2_5; last modified: 2020-10-07 01:06:47"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5_erdON_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         28570000),
  ("nof_db_files",          577),
  ("fsize_db",              1597902103751),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.60TB; nevents: 28.57M; release: 10_2_5; last modified: 2020-10-09 10:07:32"),
])
...
meta_dictionary["/TTTo2L2Nu_mtop169p5_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v2/MINIAODSIM"] =  OD([
  ...
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: VALID; size: 1.66TB; nevents: 29.35M; release: 10_2_5; last modified: 2020-10-13 02:46:59"),
])
...
meta_dictionary["/TTTo2L2Nu_mtop171p5_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         4985000),
  ("nof_db_files",          121),
  ("fsize_db",              278132760645),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 278.13GB; nevents: 4.99M; release: 10_2_5; last modified: 2020-10-09 10:10:46"),
])
...
meta_dictionary["/TTTo2L2Nu_mtop175p5_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext2-v2/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         26915000),
  ("nof_db_files",          542),
  ("fsize_db",              1507588784009),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.51TB; nevents: 26.91M; release: 10_2_5; last modified: 2020-10-10 11:02:09"),
])
