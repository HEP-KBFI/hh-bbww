...
# file generated at 2020-05-24 15:05:23 with the following command:
# create_dictionary.py -m python/samples/metaDict_2017_hh_sync_ttbar.py -p /hdfs/local/karl/ttHNtupleProduction/2017/2020May24_woPresel_nonNom_hh_bbww_sync_ttbar/ntuples -N samples_2017 -E 2017 -o python/samples -g hhAnalyzeSamples_2017_sync_ttbar.py -M
...
samples_2017["/TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v2/MINIAODSIM"] = OD([
  ...
  ("nof_events",                      {
    ...
    'CountWeightedHighPtTopPtRwgtSF'                                                 : [        46967,        46973,        46961, ],
    'CountWeightedHighPtTopPtRwgtSFSquared'                                          : [        47089,        47097,        47080, ],
    ...
    'CountWeightedLHEWeightScaleHighPtTopPtRwgtSF'                                   : [        52986,        52010,        51371,        48161,        46966,        46049,        43559,        42284,        41238, ],
    'CountWeightedLHEWeightScaleHighPtTopPtRwgtSFSquared'                            : [        53133,        52157,        51521,        48280,        47088,        46174,        43656,        42385,        41343, ],
    ...
    'CountWeightedLHEEnvelopeHighPtTopPtRwgtSF'                                      : [        57214,        38476, ],
    'CountWeightedLHEEnvelopeHighPtTopPtRwgtSFSquared'                               : [        57352,        38594, ],
    ...
    'CountWeightedPSWeightHighPtTopPtRwgtSF'                                         : [        47011,        46996,        66458,        46906,        46909,        29367, ],
    'CountWeightedPSWeightHighPtTopPtRwgtSFSquared'                                  : [        47134,        47120,        66619,        47027,        47034,        29456, ],
    ...
    'CountWeightedPSWeightOriginalXWGTUPHighPtTopPtRwgtSF'                           : [       473205,       473200,       473205,       473205,       472954,       472949, ],
    'CountWeightedPSWeightOriginalXWGTUPHighPtTopPtRwgtSFSquared'                    : [       474364,       474359,       474364,       474364,       474113,       474109, ],
    ...
    'CountWeightedL1PrefireNomHighPtTopPtRwgtSF'                                     : [        45595,        45599,        45591, ],
    'CountWeightedL1PrefireNomHighPtTopPtRwgtSFSquared'                              : [        45724,        45728,        45717, ],
    ...
    'CountWeightedL1PrefireHighPtTopPtRwgtSF'                                        : [        45595,        45258,        45923, ],
    'CountWeightedL1PrefireHighPtTopPtRwgtSFSquared'                                 : [        45724,        45388,        46051, ],
    ...
    'CountWeightedLHEWeightScaleL1PrefireNomHighPtTopPtRwgtSF'                       : [        51406,        50471,        49863,        46742,        45594,        44714,        42286,        41059,        40053, ],
    'CountWeightedLHEWeightScaleL1PrefireNomHighPtTopPtRwgtSFSquared'                : [        51561,        50626,        50020,        46868,        45722,        44844,        42389,        41166,        40163, ],
    ...
    'CountWeightedLHEEnvelopeL1PrefireNomHighPtTopPtRwgtSF'                          : [        55520,        37363, ],
    'CountWeightedLHEEnvelopeL1PrefireNomHighPtTopPtRwgtSFSquared'                   : [        55666,        37486, ],
    ...
    'CountWeightedPSWeightL1PrefireNomHighPtTopPtRwgtSF'                             : [        45648,        45614,        64507,        45523,        45559,        28522, ],
    'CountWeightedPSWeightL1PrefireNomHighPtTopPtRwgtSFSquared'                      : [        45776,        45745,        64677,        45650,        45689,        28615, ],
    ...
    'CountWeightedPSWeightOriginalXWGTUPL1PrefireNomHighPtTopPtRwgtSF'               : [       459257,       459252,       459257,       459257,       459018,       459014, ],
    'CountWeightedPSWeightOriginalXWGTUPL1PrefireNomHighPtTopPtRwgtSFSquared'        : [       460489,       460485,       460489,       460489,       460251,       460246, ],
  }),
  ("nof_tree_events",                 47260),
  ("nof_db_events",                   69155808),
  ("fsize_local",                     218405111), # 218.41MB, avg file size 218.41MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/karl/ttHNtupleProduction/2017/2020May24_woPresel_nonNom_hh_bbww_sync_ttbar/ntuples/TTTo2L2Nu_PSweights"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
