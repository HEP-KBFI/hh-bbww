...
# file generated at 2020-04-24 12:46:42 with the following command:
# create_dictionary.py -m python/samples/metaDict_2018_hh_sync_ttbar.py -p /hdfs/local/snandan/ttHNtupleProduction/2018/2020Apr22_woPresel_nonNom_hh_bbww_sync_ttbar/ntuples -N samples_2018 -E 2018 -o python/samples -g hhAnalyzeSamples_2018_sync_ttbar_test.py -M
...
samples_2018["/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM"] = OD([
  ...
  ("fsize_local",                     228505394), # 228.51MB, avg file size 228.51MB
  ...
  ("local_paths",
    [
      OD([
        ("path",      "/hdfs/local/snandan/ttHNtupleProduction/2018/2020Apr22_woPresel_nonNom_hh_bbww_sync_ttbar/ntuples/TTTo2L2Nu"),
        ("selection", "*"),
        ("blacklist", []),
      ]),
    ]
