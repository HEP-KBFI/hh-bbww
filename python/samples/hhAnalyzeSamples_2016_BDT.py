...
for sample_name, sample_info in samples_2016.items():
  ...
  sample_info["use_it"] = sample_info["process_name_specific"].startswith(('signal_ggf'))\
                          or  sample_info["process_name_specific"].startswith(('signal_vbf'))\
                          or  sample_info["process_name_specific"] in ["TTToSemiLeptonic"]
