...
# file generated at 2020-10-19 14:16:11 with the following command:
...
meta_dictionary["/TTTo2L2Nu_hdampDOWN_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3_ext2-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         20789000),
  ("nof_db_files",          277),
  ("fsize_db",              919053241267),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 919.05GB; nevents: 20.79M; release: 9_4_9; last modified: 2020-10-09 10:05:07"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5CR1_QCDbased_PSweights_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3_ext1-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         24185600),
  ("nof_db_files",          337),
  ("fsize_db",              1081438385343),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.08TB; nevents: 24.19M; release: 9_4_9; last modified: 2020-10-09 10:03:10"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5CR2_GluonMove_PSweights_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3_ext1-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         8266600),
  ("nof_db_files",          121),
  ("fsize_db",              367321612287),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 367.32GB; nevents: 8.27M; release: 9_4_9; last modified: 2020-10-09 13:10:11"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5_PSweights_erdON_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3_ext2-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_events",         24987100),
  ("nof_db_files",          315),
  ("fsize_db",              1107419219873),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "status: PRODUCTION; size: 1.11TB; nevents: 24.99M; release: 9_4_9; last modified: 2020-10-09 10:06:20"),
])
