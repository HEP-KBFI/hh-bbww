...
# file generated at 2020-04-21 13:35:24 with the following command:
...
meta_dictionary["/TTToHadronic_hdampUP_TuneCP5_PSweights_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM"] =  OD([
  ...
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "99.31%; status: VALID; size: 1.34TB; nevents: 28.70M; release: 9_4_9; last modified: 2020-01-16 21:45:00"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5CR2_GluonMove_PSweights_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM"] =  OD([
  ...
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "100.0%; status: PRODUCTION; size: 666.40GB; nevents: 15.06M; release: 9_4_9; last modified: 2020-01-24 00:07:28"),
])
...
meta_dictionary["/TTToSemiLeptonic_TuneCP5_PSweights_erdON_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM"] =  OD([
  ...
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "96.38%; status: VALID; size: 1.32TB; nevents: 28.97M; release: 9_4_9; last modified: 2020-03-18 13:51:28"),
])
...
meta_dictionary["/TTTo2L2Nu_TuneCP5_PSweights_mtop1755_13TeV-powheg-pythia8/RunIISummer16MiniAODv3-PUMoriond17_backup_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM"] =  OD([
  ...
  ("nof_db_files",          81),
  ("fsize_db",              142960320277),
  ("xsection",              88.4),
  ("use_it",                False),
  ("genWeight",             True),
  ("comment",               "100.0%; status: PRODUCTION; size: 142.96GB; nevents: 3.22M; release: 9_4_9; last modified: 2020-03-02 18:59:19"),
])
