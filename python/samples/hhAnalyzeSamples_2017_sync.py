from hhAnalysis.bbww.samples.hhAnalyzeSamples_2017_hh import samples_2017
...
samples_2017[sync_key]['local_paths'][0]['path'] = '/hdfs/local/karl/ttHNtupleProduction/2017/2019Jan25_woPresel_nom_hh_bbww_sync/ntuples/signal_ggf_spin0_750_hh_2b2v'
