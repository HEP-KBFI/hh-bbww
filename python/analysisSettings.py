...
class systematics_bbww(systematics):
  an_full_hh_bbww = systematics.central + systematics.JES + systematics.JER + systematics.leptonIDSF + \
                    ...
                    systematics.mcClosure + systematics.ttbar + systematics.pdf + systematics.LHEVpt # + systematics.pdf_mem
  an_opts_hh_bbww = [
    ...
    "leptonIDSF_hh_recomp", systematics.mcClosure_str, "ttbar", "pdf", "LHEVpt", # "pdf_mem"
  ]
  an_internal_hh_bbww = systematics.central + systematics.leptonIDSF + systematics.btag + systematics.lhe + \
                        ...
                        systematics.pdf + systematics.pdf_mem + systematics.LHEVpt
